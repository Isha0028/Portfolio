...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wa(e,t,n){return new $r({name:`SphericalGaussianBlur`,defines:{SAMPLES:la,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Da(),fragmentShader:`
	...
	`}var Oa=class extends Dt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function _c(){let e=(0,r.useRef)(null);return(0,r.useEffect)(()=>{let t=e.current;if(!t)return;let n=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,r=new pn,i=new Ai(-1,1,1,-1,0,1),a={uTime:{value:0},uMouse:{value:new q(.5,.5)},uResolution:{value:new q(1,1)}},o=new $r({vertexShader:hc,fragmentShader:gc,uniforms:a}),s=new jr(new Wr(2,2),o);r.add(s);let c=new pc({antialias:!1,powerPreference:`low-power`});c.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),t.appendChild(c.domElement),c.domElement.className=`h-full w-full`;let l=new q(.5,.5);function u(){if(!t)return;let{clientWidth:e,clientHeight:n}=t;c.setSize(e,n),a.uResolution.value.set(e,n)}u();let d=new ResizeObserver(u);d.observe(t);function f(e){let n=t.getBoundingClientRect();l.x=(e.clientX-n.left)/n.width,l.y=1-(e.clientY-n.top)/n.height}window.addEventListener(`pointermove`,f);let p=!0,m=new IntersectionObserver(([e])=>{p=e.isIntersecting});m.observe(t);let h=0,g=new qi;function _(){h=requestAnimationFrame(_),p&&!document.hidden&&(a.uMouse.value.lerp(l,.06),n||(a.uTime.value+=g.getDelta()),c.render(r,i))}return _(),()=>{cancelAnimationFrame(h),d.disconnect(),m.disconnect(),window.removeEventListener(`pointermove`,f),c.dispose(),o.dispose(),s.geometry.dispose(),c.domElement.parentElement===t&&t.removeChild(c.domElement)}},[]),(0,mc.jsx)(`div`,{ref:e,className:`absolute inset-0 -z-10`})}export{_c as default};